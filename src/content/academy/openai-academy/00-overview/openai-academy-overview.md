...
**说明：** 本文是基于 OpenAI Academy 公开页面整理的学习索引，不是官方译文，也不复刻课程原文。当前版本承担“资料整理”和“学习路线导航”的作用，并把每个模块整理成可直接练习、复盘和延伸的学习笔记。
...
如果读者要继续做个人实践记录，可以在每篇文章的「实践记录模板」里补充：
...
这样公开笔记保持稳定，个人经验也有地方沉淀，不会让读者误以为正文仍处于未定稿状态。
