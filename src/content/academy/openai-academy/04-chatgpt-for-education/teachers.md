...
**说明：** 本文整理教师场景，强调 AI 增强教师判断而非替代教师。
...
| --- | --- |
| 备课 | 目标、活动、材料、时间安排 |
| 差异化材料 | 按阅读水平、兴趣、语言能力改写 |
| 反馈草稿 | 按 rubric 生成具体建议 |
| 课堂活动 | 讨论题、练习题、分组任务 |
| 家校沟通 | 清楚、克制、可理解的沟通草稿 |
...
```text
我正在为 [年级/课程] 设计关于 [主题] 的一节课。
学习目标是 [目标]，学生常见困难是 [困难]。
请给 3 个活动方案，每个包括步骤、材料、可能误解和评价方式。
标出需要我人工确认的地方。
```

## 边界

AI 可以帮教师准备材料，但不能替代教师了解学生、判断课堂气氛和承担评价责任。
...
这一页可以当作 **Teachers** 的系统学习稿。它面向K-12 或课堂教师，重点不是背官方术语，而是把页面里的能力、场景和边界转成可以反复使用的工作方法。

### 学习目标

- 用 ChatGPT 支持备课、差异化教学、反馈和课堂活动设计。
- 保护学生隐私并维护学术诚信。
- 让 AI 辅助教师，而不是替代专业判断和师生关系。

### 官方内容拆解

| 模块 | 学习重点 | 可产出材料 |
| --- | --- | --- |
| Lesson planning | 目标、材料、活动、时间 | lesson plan |
| Differentiation | 不同水平学生支持 | 分层练习 |
| Feedback | rubric、草稿反馈 | 反馈句式 |
| Classroom materials | quiz、worksheet、discussion prompt | 可打印材料 |
| Reflection | 课后复盘和改进 | 改课建议 |
...
```text
请为[年级/学科]设计一节课，目标是[目标]。请给教学流程、材料、分层支持、检查理解的问题、课后作业和教师需要人工确认的地方。
```
...
一位教师要准备一节差异化课堂，并给不同水平学生提供支持。 你可以把输入材料设定为：年级、学科、目标、学生水平、时间、材料限制。最后产出 lesson plan、分层材料、课堂检查题、课后复盘。

### 原创 Prompt Pack

1. 请为这节课设计 lesson plan。
2. 请为不同水平学生生成三档练习。
3. 请设计课堂中检查理解的 6 个问题。
4. 请把复杂概念改成学生易懂解释。
5. 请生成课后教师复盘问题。
...
![ChatGPT for education](https://images.ctfassets.net/kftzwdyauwt9/3oIacja57T4O2dlR52RbVJ/efd304faeede3b0e448e377cee270bb1/teachers.png?w=3840&q=90&fm=webp)
