---
title: "OpenAI Academy 笔记：Faculty and Professors"
date: 2026-04-25
category: academy
...
2. 哪些任务必须披露 AI 使用。
3. 哪些任务禁止 AI 代写。
4. 学生如何提交 prompt 或过程记录。
5. 评价重点是最终答案还是学习过程。

## 边界

AI 能帮助教师设计材料，但不能替代学科判断、学生评价和研究伦理。
...
这一页可以当作 **Faculty and Professors** 的系统学习稿。它面向高校教师、研究者和课程负责人，重点不是背官方术语，而是把页面里的能力、场景和边界转成可以反复使用的工作方法。

### 学习目标

- 支持课程设计、研究沟通、学术写作和学生反馈。
- 在学术诚信、引用、隐私和学科标准下使用 AI。
- 把 AI 纳入教学设计而不是只作为禁用对象。

### 官方内容拆解

| 模块 | 学习重点 | 可产出材料 |
| --- | --- | --- |
| Course design | 学习目标、阅读、活动、评估 | syllabus draft |
| Research communication | 摘要、grant、presentation | 清晰草稿 |
| Feedback | rubric、comment banks | 反馈框架 |
| Policy | AI 使用规则、作业说明 | course AI policy |
| Accessibility | 多样化材料和支持 | 学习资源版本 |
...
```text
请帮我为[课程/主题]设计一个教学单元。请包含学习目标、课堂活动、阅读/资源、评估方式、AI 使用政策提示和需要教师审查的内容。
```
...
一位高校教师要更新课程大纲，并明确学生可如何使用 AI。 你可以把输入材料设定为：课程目标、学生背景、评估方式、学校政策、学科规范。最后产出 syllabus 草案、AI policy、rubric、课堂活动。

### 原创 Prompt Pack

1. 请为这门课更新 syllabus 结构。
2. 请写一段清晰的课程 AI 使用政策。
3. 请设计一个要求学生透明披露 AI 使用的作业。
4. 请为论文草稿反馈设计 rubric。
5. 请生成课堂讨论问题，帮助学生批判性使用 AI。

### 自测问题

- 我能不能用自己的话解释“Faculty and Professors”解决的核心问题？
...
![ChatGPT for education](https://images.ctfassets.net/kftzwdyauwt9/QJTDrIOMOna26jJo6kUpj/fac5f8764e968d377fb130e5f177dc7d/faculty-professors.png?w=3840&q=90&fm=webp)
