...
运营工作常常不是缺想法，而是流程分散、责任不清、交接低效、状态同步成本高。ChatGPT 可以帮助把流程说清楚、把材料转成 SOP、把杂乱更新转成行动列表。

## 典型场景

| 场景 | 输出 |
| --- | --- |
| 流程诊断 | bottleneck、handoff 风险、简化建议 |
| SOP 文档 | 标准步骤、例外处理、升级路径 |
| 状态同步 | 本周进展、风险、决策需求 |
| 会议纪要 | 行动项、owner、deadline |
| 运营数据 | 变化、异常、后续分析问题 |

## 好的 prompt

```text
请阅读这个流程说明，找出容易造成延迟或责任不清的地方。
输出：
1. 当前流程摘要
2. 主要瓶颈
3. 可以 2 周内测试的改进
...
流程建议看起来简单，但现实里会遇到权限、组织边界和已有系统限制。任何改流程建议都要找实际 owner 复核。
