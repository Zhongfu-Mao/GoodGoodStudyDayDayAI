...
ChatGPT や Claude で同じ質問を 2 通りの聞き方で試してください。

**聞き方 1**：`太陽系の惑星はいくつ？`（答えだけ求める）

**聞き方 2**：`小学生に太陽系を説明したいです。8 つの惑星を太陽に近い順に並べ、それぞれ一言で面白い特徴を教えてください。`（協力相手として使う）

どちらがすぐ使える回答か比べてみてください。
