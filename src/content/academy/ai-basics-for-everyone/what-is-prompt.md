...
用文中的低成本模板，为你自己这周的一个真实任务写一个 prompt。比如：

```text
我想完成：写一封回复客户的邮件
背景是：客户问了产品价格，我需要报一个折扣方案
请你帮我：起草一封 200 字以内的邮件
限制条件：专业但不过度正式，不要夸大产品效果
输出格式：直接给邮件正文，开头用"您好"
如果信息不够，请先列出需要我补充的问题。
```

把模板里的方括号替换成你自己的内容，然后发给 ChatGPT 或 Claude，看看结果是否比"帮我写封邮件"好。
