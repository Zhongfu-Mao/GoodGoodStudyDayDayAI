...
## 読者向け補足：授業文脈を再利用可能にする

Teaching Context Document は、毎回の prompt を長くするための文書ではありません。授業の目的、学生の前提、評価基準、使ってよい資料、避けたい支援を一か所にまとめ、AI とのやり取りを授業設計に接続するための土台です。

授業単位で一度作っておくと、教材作成、ルーブリック案、個別支援、保護者向け説明、授業後の振り返りに同じ文脈を使えます。重要なのは、学生の個人情報や評価に直結する機密情報を入れすぎないことです。

| 入れるもの | 入れないもの |
| --- | --- |
| 授業目標、対象学年、前提知識 | 学生個人の詳細な成績や診断情報 |
| 使ってよい教材、引用ルール | 未公開の試験問題や機密資料 |
| 望ましい支援、避けたい支援 | AI に代替させたい採点判断 |

### ミニ演習

次回の授業について、AI に渡してよい文脈だけで 300 字の Teaching Context Document を作ります。その後、AI に「この文脈で過剰支援になりやすい場面」を挙げてもらい、授業ルールに反映します。
